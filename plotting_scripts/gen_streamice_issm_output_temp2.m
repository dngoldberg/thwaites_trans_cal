...
%mix_fwd_dir='run_val_coul_tc_gentim_g00S_mix_last_50_n_.05e5_.2e5_.001';
...
% snapshot
%close all
function gen_streamice_issm_output(mix_fwd_dir);
...
surf_fwd_dir='run_val_coul_tc_gentim_g00S_surf_last_50_n_.05e5_.2e5';
...
morlighem_files={'../morlighem_output/output_13_2/Transient_Calibration_ForDan.mat', ...
    '../morlighem_output/output_13_2/Transient_CalibrationSurfaceOnly_ForDan.mat', ...
    '../morlighem_output/output_13_2/Transient_CalibrationVelocityOnly_ForDan.mat', ...
    '../morlighem_output/output_13_2/Transient_Snapshot_ForDan.mat'};

dan_folders={['/home/dgoldber/network_links/geosIceOcean/dgoldber/archer_output/THWAITES/iter40/' mix_fwd_dir],...
      ['/home/dgoldber/network_links/geosIceOcean/dgoldber/archer_output/THWAITES/iter40/' surf_fwd_dir],...
	     '/home/dgoldber/network_links/geosIceOcean/dgoldber/archer_output/THWAITES/run_val_coul_tc_gentim_g00S_vel_last_50_n',...
...
for i=ilist;
    ...
    [metric_vel_st metric_acc_st metric_surf_st metric_dhdt_st metric_dvaf_st T_st Vaf_st Tobs1 Tobs2 Tobs0 vafobs Bglen Beta] = ...
        plot_val(do_plots, do_cal_plots, []);
    if (save_files)
...
% 
% if (isfile('LcurveSurfBeta.mat'));
%     load LcurveSurfBeta.mat
%     Lcurvedata(gam)=obj;
% else
%     Lcurvedata = containers.Map([gam],obj)
% end
% 
% save LcurveSurfBeta.mat Lcurvedata;
