...
if (isempty(ad_folder))
    ...
    thick0 = rdmds(['../' ad_folder '/runoptiter040/H_streamiceinit'])';
end
...
surf_a = zeros(length(J),length(I),756/12);
thick_a = zeros(length(J),length(I),756/12);
vx_a = zeros(length(J),length(I),756/12);
vy_a = zeros(length(J),length(I),756/12);
