...
bash resubmit_ad.sh exp_surf_constr.txt

sed "s/.*BigConstr.*/BigConstr: vel/" ../params/exp1.txt > exp_vel_constr.txt;
bash resubmit_ad.sh exp_vel_constr.txt
...
#sed "s/.*Smith.*/Smith: SC/" exp_mix_constr.txt > exp_mix_constr_smbigmelt.txt
#bash submit_ad.sh exp_mix_constr_smbigmelt.txt
...
bash resubmit_ad.sh exp_mix_constr_meltspatial.txt

sed "s/.*gentim.*/gentim: gentimlong/" exp_mix_constr.txt > exp_mix_constr_long.txt
bash submit_ad.sh exp_mix_constr_long.txt
sed "s/BetaType.*/BetaType: 1/" exp_mix_constr_long.txt > exp_mix_constr_long_betavar.txt
bash submit_ad.sh exp_mix_constr_long_betavar.txt
