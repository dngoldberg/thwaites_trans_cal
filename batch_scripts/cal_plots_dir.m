...
[metric_vel1_st metric_acc1_st  metric_accrel1_st metric_surf1_st metric_dhdt1_st dvafdt_err1_st tikhbeta wgtvel wgtsurf betacost bglencost priorcost thincost velcost T_st Vaf_st Tobs1 Tobs2 Tobs0 vafobs Bglen_st Beta_st] = ...
    plot_val(do_plots, do_cal_plots, [],period);
if isempty(rec)
    rec=2;
end

[metric_vel1_is metric_acc1_is  metric_accrel1_is metric_surf1_is metric_dhdt1_is dvafdt_err1_is tikhbeta0 wgtvel0 wgtsurf0 betacost0 bglencost0 priorcost0 thincost0 velcost0 T_is Vaf_is Tobs1 Tobs2 Tobs0 vafobs Bglen_is Beta_is] = ...
    plot_val(do_plots, do_cal_plots,  morlighem_files{rec}, period);
