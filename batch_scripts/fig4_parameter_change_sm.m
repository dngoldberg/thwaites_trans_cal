...
expFolders={'/exports/geos.ed.ac.uk/iceocean/dgoldber/archer_output/THWAITES/LCURVE/run_ad_coul_tc_surf_a0a966bceb3f', ...
            '/exports/geos.ed.ac.uk/iceocean/dgoldber/archer_output/THWAITES/LCURVE_VEL/run_ad_coul_tc_vel_855b2af022e4'};
...
% Beta_st=rdmds([expFolders{1} '/runoptiter040/C_basal_fric'])'+rdmds([expFolders{1} '/gradcontrol/xx_beta'],40)';
% Bglen_st=rdmds([expFolders{1} '/runoptiter040/B_glen_sqrt'])'+rdmds([expFolders{1} '/gradcontrol/xx_bglen'],40)';
% Beta_st=Beta_st(J,I);
% Bglen_st=Bglen_st(J,I);
...
% Beta_st=rdmds([expFolders{2} '/runoptiter075/C_basal_fric'])'+rdmds([expFolders{2} '/gradcontrol/xx_beta'],75)';
% Bglen_st=rdmds([expFolders{2} '/runoptiter075/B_glen_sqrt'])'+rdmds([expFolders{2} '/gradcontrol/xx_bglen'],75)';
% Beta_st=Beta_st(J,I);
% Bglen_st=Bglen_st(J,I);
...
for j=1:2;
    ...
    for k=1:2
        ...
        subplot(2,2,(j-1)*2+k)
        eval(['K=abs(' params{1} '_' constr{j} '_' models{k} ').^1-abs(' params{1} '_snap_' models{k} ').^1;']);
        K = imgaussfilt(K,2);
        pcolor(x_mesh_mid,y_mesh_mid,K); shading flat
